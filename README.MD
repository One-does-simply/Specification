...
### Branding & Theming
 * `branding.theme` — Named theme from the catalog (e.g., `"corporate"`, `"nord"`, `"dracula"`). 35 themes available based on DaisyUI, each with light and dark variants. See `Themes/catalog.json`.
